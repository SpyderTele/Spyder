...
io.write('\27[1;31m ⌔︙الان ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SpyderBOT1/Files_Spyder/master/File_Bot/games.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SpyderBOT1/Files_Spyder/master/File_Bot/Reply.lua") 
...
sudo_users = {SUDO,332581832,1141581647}
...
if tonumber(user_id) == tonumber(123456789) then  
var = 'مطور السورس👨‍🔧'
elseif tonumber(user_id) == tonumber(183628388) then
var = 'مطور السورس👨‍🔧'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي👨‍💻'  
...
local Spyder_Msg = ''  
if msgs < 100 then 
Spyder_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
Spyder_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
Spyder_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
Spyder_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
Spyder_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
Spyder_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
Spyder_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
Spyder_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
Spyder_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Spyder_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Spyder_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Spyder_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Spyder_Msg = 'رب التفاعل✔️😍'  
end 
return Spyder_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSpyder(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,'⌔︙عدد المجموعات الان ↫ { '..#group..' }'..Spyderk..''..Spyder..'\n*⌔︙الان عدد المجموعات الحقيقي ↫ { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⌔︙العضو ↫ ['..result.title_..'](t.me/'..(username or 'SAIKO_CH')..')'
...
usertext = '\n⌔︙العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'SAIKO_CH')..')'
status  = '\n⌔︙تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if Spyder_Msg and not Special(msg) then  
local Spyder_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Spyder_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌔︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..Spyder_Msg.."] \n") 
else
send(msg.chat_id_,0,"⌔︙العضو : {["..data.first_name_.."](T.ME/SAIKO_CH)}\n⌔︙["..Spyder_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌔︙عذرا يا ↫ {["..data.first_name_.."](T.ME/SAIKO_CH)}\n⌔︙الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌔︙بواسطه   ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAIKO_CH')..') \n⌔︙تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔︙بواسطه   ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAIKO_CH')..') \n⌔︙تـم قفـل التاك بالكتم\n⌔︙الحاله  الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SpyderBOT1/Files_Spyder/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︙اهلا بك في متجر ملفات دودي\n⌔︙ملفات السورس ↓\nٴ… … … … … … … … … … … … …\n\n"
local TextE = "\nٴ… … … … … … … … … … … … …\n⌔︙ علامة تعني { ✓ } ملف مفعل\n⌔︙علامة تعني { ✘ } ملف معطل\n⌔︙قناة سورس دودي ↓\n".."⌔︙[اضغط هنا لدخول](t.me/SAIKO_CH) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SpyderBOT1/Files_Spyder/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Spyder.lua')  
else
send(msg.chat_id_, msg.id_,"⌔︙عذرا هاذا ملف ليس من ملفات سورس دودي\n") 
end
return false
end
...
local UserName = (b.username_ or "SAIKO_CH")
...
' }\n'..'⌔︙الايدي بالصوره   { '..idph..
' }\n'..'⌔︙الرفع   { '..setadd..
' }\n'..'⌔︙الحظر   { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n⌔︙CH ↫ [Channel Spyder 🦅](https://t.me/SAIKO_CH)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
t = "\n⌔︙قائمة المنع \nٴ… … … … … … … … … … … … …\n"
for k,v in pairs(list) do  
local Spyder_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' ↫ {'..Spyder_Msg..'}\n'    
end  
if #list == 0 then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔︙العضو   ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SAIKO_CH')..') \n⌔︙تـم قفـل التفليش\n⌔︙الحاله   المسح ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔︙العضو ↫ ['..result.title_..'](t.me/'..(text1[3] or 'SAIKO_CH')..')'..'\n⌔︙تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دودي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دودي')
local Spyder_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'حبيبي القميل كول 😻',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دودي').."مغادره" or text == 'مغادره' or text == 'مغادرة' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دودي')
...
local Json_Info = JSON.decode(Spyder)
...
--------------------------------------------------------------------------------------------------------------
SourceSpyder(data.message_,data)
...
------------------------------------------------------------------------
local Spyderbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Spyderbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌔︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..Spyderbot.."] \n") 
