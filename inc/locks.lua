...
else redis:del(Spyder.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(Spyder.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(Spyder.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(Spyder.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل  ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(Spyder.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(Spyder.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 

redis:del(Spyder.."lock_cleaner"..msg.chat_id_)
local Cleaner = redis:smembers(Spyder..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
redis:del(Spyder..":SetTimerCleaner:"..msg.chat_id_..v) 
Del_msg(msg.chat_id_,v)
end
redis:del(Spyder..":IdsMsgsCleaner:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(Spyder.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(Spyder.."lock_cleaner"..msg.chat_id_,true)
