...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(Spyder..":NameBot:") or "الزعيم"
...
local NumberFlood = tonumber(redis:get(Spyder..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(Spyder..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
local creator = redis:smembers(Spyder..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
Spyder..'num_msg_max'..id_group,
Spyder..'mute_text'..id_group,
Spyder..'admins:'..id_group,
Spyder..':Filter_Word:'..id_group,
Spyder..'banned:'..id_group,
Spyder..'is_silent_users:'..id_group,
Spyder..'whitelist:'..id_group,
Spyder..':MONSHA_BOT:'..id_group,
Spyder..'owners:'..id_group,
Spyder..'replay'..id_group,
Spyder..':MONSHA_Group:'..id_group
)
...
redis:sadd(Spyder..'admins:'..arg.chat_id_,data.id_)
...
redis:mset(
Spyder..'group:add'..arg.chat_id_,true,
Spyder..'lock_link'..arg.chat_id_,true, 
Spyder..'lock_id'..arg.chat_id_,true,
Spyder..'lock_spam'..arg.chat_id_,true,
Spyder..'lock_webpage'..arg.chat_id_,true,
Spyder..'lock_markdown'..arg.chat_id_,true,
Spyder..'lock_flood'..arg.chat_id_,true,
Spyder..'lock_bots'..arg.chat_id_,true,
Spyder..'mute_forward'..arg.chat_id_,true,
Spyder..'mute_contact'..arg.chat_id_,true,
Spyder..'mute_location'..arg.chat_id_,true,
Spyder..'mute_document'..arg.chat_id_,true,
Spyder..'mute_keyboard'..arg.chat_id_,true,
Spyder..'mute_game'..arg.chat_id_,true,
Spyder..'mute_inline'..arg.chat_id_,true,
Spyder..'lock_username'..arg.chat_id_,true,
...
redis:sadd(Spyder..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(Spyder..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(Spyder..'linkGroup'..arg.chat_id_,Gp_Link)
...
.."\n#️⃣¦ التاك » "..(redis:get(Spyder..'lock_tag'..msg.chat_id_) or 'false')
