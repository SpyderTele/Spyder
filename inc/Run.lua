...
if not Token then
io.write('\n\27[1;33m < Send right Now Token Bot Your > \27[0;39;49m')
Token = io.read():gsub(' ','')
if Token == '' then
print('\n\27[1;31m Sorry did not Do not Inserting Token ? ')
create_config()
end
Api_Token = 'https://api.telegram.org/bot'..Token
local url , res = https.request(Api_Token..'/getMe')
if res ~= 200 then
print('\n\27[1;31m Token Which You entered Non True Try again ... ! ')
create_config()
end
local GetToken = JSON.decode(url)
BOT_NAME = GetToken.result.first_name
BOT_User = "@"..GetToken.result.username
io.write('\n\27[1;36m Done Token Preservation  Successfully √ \27[1;34m@'..GetToken.result.username..'\n\27[0;39;49m') 
end
io.write('\n\27[1;33m = Send User ID Sudo Your :\27[0;39;49m')
SUDO_USER = io.read():gsub(' ','')
if SUDO_USER == '' then
print('\n\27[1;31m did not Do not Enter it User ID Try again ')
create_config(Token)
end 
if not SUDO_USER:match('(%d+)(%d+)(%d+)(%d+)(%d+)') then
print('\n\27[1;31m Sorry This is Not User ID .. !')
create_config(Token)
end 
print('('..SUDO_USER..')')
...
Spyder = Token:match("(%d+)")
redis:set(Spyder..":VERSION",2.9)
redis:set(Spyder..":SUDO_ID:",SUDO_USER)
redis:set(Spyder..":DataCenter:",'German')
redis:set(Spyder..":UserNameBot:",BOT_User)
redis:set(Spyder..":NameBot:",BOT_NAME)
redis:hset(Spyder..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3Spyder_INSTALL","Yes")
info = {}
...
if redis:get(Spyder..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(Spyder..'group:add'..msg.chat_id_) then 
...
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(Spyder..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(Spyder..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(Spyder..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(Spyder..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(Spyder..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(Spyder..':WELCOME_BOT'),[[🙋🏽‍♂╿ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(Spyder..':NameBot:')..[[ ⚜
...
if msg.Admin then redis:srem(Spyder..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(Spyder..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
for k, Spyder in pairs(ScriptFile.Spyder) do
local SearchText = msg.text:match(Spyder)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.iSpyder(msg,{msg.text:match(Spyder)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Spyder.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dSpyder then
if ScriptFile.dSpyder(msg) == false then
return false
end
...
if Plug.Spyder then 
if msg.text and Plug.iSpyder then
for k, Spyder in pairs(Plug.Spyder) do
local SearchText = msg.text:match(Spyder)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(Spyder..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(Spyder..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.iSpyder(msg,{msg.text:match(Spyder)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Spyder.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dSpyder then
Plug.dSpyder(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source Spyder")
end 

end
else
print("The File Script.lua Not Runing in The Source Spyder")
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/SpyderTele/Spyder/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/Run.lua','./inc/Run.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/Script.lua','./inc/Script.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/inc/locks.lua','./inc/locks.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/SpyderTELLE/Spyder/master/plugins/games.lua','./plugins/games.lua')
	...
	mmd = redis:get(Spyder..":SUDO_ID:")
redis:hset(Spyder..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(Spyder..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(Spyder..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(Spyder..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(Spyder..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(Spyder..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(Spyder..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(Spyder..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(Spyder..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(Spyder..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
