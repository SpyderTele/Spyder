...
redis:set(Spyder.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Spyder..'lock:join:'..msg.chat_id_,true)
...
redis:del(Spyder..'lock:join:'..msg.chat_id_)
...
Channel = redis:get(Spyder..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Spyder..'joinchnl') then
...
local GroupName = (redis:get(Spyder..'group:name'..msg.chat_id_) or '')
redis:set(Spyder..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(Spyder..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Spyder..'')
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Spyder..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
if redis:get(Spyder..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Spyder..'lock:kara:'..msg.chat_id_) == 'on' then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(Spyder..'linkGroup'..msg.sender_user_id_,300,true)
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(Spyder..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(Spyder..':Hussain:'..msg.chat_id_)
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Spyder..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Spyder..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Spyder..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Spyder..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local points = redis:get(Spyder..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(Spyder..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if redis:get(Spyder.."getidstatus"..msg.chat_id_) == "Photo" then
...
redis:del(Spyder..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
...
local adduser = redis:get(Spyder..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*│*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(Spyder..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
redis:del(Spyder..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(Spyder..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(Spyder..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(Spyder..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(Spyder..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(Spyder..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(Spyder..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(Spyder..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(Spyder..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(Spyder..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(Spyder..':NameBot:')..[[ 🎖️
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*│*عدد المشتركين في البوت : `'..redis:scard(Spyder..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(Spyder..'group:ids',MsgText[2]) then
...
return '👨🏾‍🔧│ اصدار سورس سبايدر : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/SpyderTELLE/Spyder.github.io/GetVersion.txt') or 0
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(Spyder..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(Spyder..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(Spyder..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(Spyder..'lave_me'..msg.chat_id_,true)  
...
return '🚸*│*عدد سحہكآتگ ⇜ ❪ '..(redis:get(Spyder..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
if redis:get(Spyder..'welc'..msg.chat_id_) == 'on' then
...
local hash = Spyder..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
Black = msg.text 
mmd = redis:get(Spyder..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(Spyder..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(Spyder..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'🙋🏻‍♂╿اهلا عزيزي \n📡╽تم تثبيت الامر الجديد\n✓')
redis:del(Spyder..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Spyder..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(Spyder..'CmD:'..msg.chat_id_,cmd)
redis:srem(Spyder..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهلا عزيزي\nالامر >"..cmd.."\n📡╽ تم مسحه من قائمه الاوامر\n✓")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
redis:del(Spyder..'CmD:'..msg.chat_id_)
redis:del(Spyder..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♦️| اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local CmDlist = redis:smembers(Spyder..'CmDlist:'..msg.chat_id_)
local t = '♦️| قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(Spyder..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(Spyder..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(Spyder..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(Spyder..'welc'..msg.chat_id_,'off')
redis:del(Spyder..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,Spyder)   
if Spyder.content_.ID == "MessageSticker" then        
local bd = Spyder.content_.sticker_.sticker_.path_          
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(Spyder..':NameBot:')..[[]🎖️
💰¦ آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
🚸¦ فقط آلمـطـور يسـتطـيع تفعيل آلبوت
...
local inline = {{{text="آلمـطـور ™️",url="t.me/"..xsudouser}}}
...
local MSG_ID = (redis:get(Spyder.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
elseif msg.voice then
redis:hset(Spyder..'replay_voice:group:',klma,voice_id)
redis:del(Spyder..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Spyder..'replay_animation:group:',klma,animation_id)
redis:del(Spyder..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Spyder..'replay_video:group:',klma,video_id)
redis:del(Spyder..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Spyder..'replay_audio:group:',klma,audio_id)
redis:del(Spyder..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Spyder..'replay_sticker:group:',klma,sticker_id)
redis:del(Spyder..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(Spyder.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(Spyder.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if not redis:get(Spyder..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⚠¦ انت منشئ المجموعه ') 
return false
end
local Added_Me = redis:get(Spyder.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
if redis:get(Spyder..'Added:Me'..msg.chat_id_) then
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تفعيل امر منو ضافني\n✓")
redis:del(Spyder..'Added:Me'..msg.chat_id_)  
else
...
if not redis:get(Spyder..'Added:Me'..msg.chat_id_) then
redis:set(Spyder..'Added:Me'..msg.chat_id_,true)  
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تعطيل منو ضافني\n✓")
else
...
if redis:get(Spyder..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(Spyder..'linkGroup'..msg.sender_user_id_,link) 
redis:set(Spyder..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
...
if msg.adduser and msg.adduser == our_id and redis:get(Spyder..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(Spyder..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(Spyder..':NameBot:')..[[ ✓
...
if msg.forward_info and redis:get(Spyder..'fwd:'..msg.sender_user_id_) then
...
sendMsg(msg.chat_id_,msg.id_,'🔘*¦*صار ستاذي باي')
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(Spyder..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(Spyder..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(Spyder..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
...
--------------------------------------------
if msg.adduser and redis:get(Spyder..'welcome:get'..msg.chat_id_) then
...
if not msg.forward_info and redis:get(Spyder..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(Spyder..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_Spyder = (redis:get(Spyder..'num_msg_Spyder'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_Spyder) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(Spyder..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_Spyder.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(Spyder..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(Spyder..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(Spyder..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(Spyder..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(Spyder..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(Spyder..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(Spyder..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(Spyder..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(Spyder..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(Spyder..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"آسمي ["..Bot_Name.."] ❤️🌝")
