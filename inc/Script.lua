...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(Spyder..':NameBot:')..[[ ✓
...
🤖│[بوت تواصل](t.me/TUaSiLSpyderbot)
...
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(Spyder..':NameBot:')..[[] 🗽
